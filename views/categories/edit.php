        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Chỉnh sửa thông tin danh mục</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="index.php?act=category-edit&id=<?= $category['id'] ?>">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      name="description" 
                                      rows="4"
                                      placeholder="Nhập mô tả cho danh mục..."><?= htmlspecialchars($_POST['description'] ?? $category['description']) ?></textarea>
                            <div class="form-text">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <a href="index.php?act=category-show&id=<?= $category['id'] ?>" class="btn btn-info me-md-2">
            ...
            <div class="card mt-4 border-danger">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">
                        Xóa danh mục này sẽ không thể khôi phục. Hãy chắc chắn trước khi thực hiện.
                    </p>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <ul class="mb-0">
                        <li><strong>Tên danh mục:</strong> Bắt buộc, ít nhất 2 ký tự, không được trùng lặp với danh mục khác.</li>
                        <li><strong>Mô tả:</strong> Tùy chọn, giúp mô tả chi tiết về danh mục.</li>
                        <li>Sau khi cập nhật thành công, bạn sẽ được chuyển về danh sách danh mục.</li>
                        <li><strong>Lưu ý:</strong> Việc xóa danh mục không thể hoàn tác.</li>
                    </ul>
                </div>
            </div>
        </div>
